...
import {removeItemFromCart, updateCartQuantity,addItemToCart} from "../../actions/cartAction";
    ...
    <div className='col-sm-12 col-md-6 col-lg-3 my-3'>
        <div className="card p-3 rounded">
            ...
            <div className="card-body d-flex flex-column">
                ...
                <p className="fooditem_des">{fooditem.description}
                </p>
                ...
                {
                    !showButtons?(
                        <button type='button' id='cart_btn' className="btn btn-primary d-inline ml-4" disabled={fooditem.stock===0} onClick={addToCartHandler}>Add to Cart</button>
                    ):(
                        <div className="stockCounter d-inline">
                            ...
                            <span className="btn btn-primary minus" onClick={increaseQty}>
                                +
                            </span>
                        </div>
                    )
